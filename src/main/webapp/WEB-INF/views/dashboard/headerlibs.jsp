...
<!-- page stylesheets -->
<link rel="stylesheet" href='<c:url value="/resources/vendor/sweetalert/dist/sweetalert.css"/>'>
<!-- end page stylesheets -->
<!-- build:css({.tmp,app}) styles/app.min.css -->
<link rel="stylesheet" href='<c:url value="/resources/vendor/bootstrap/dist/css/bootstrap.css"/>'>
<link rel="stylesheet" href='<c:url value="/resources/vendor/PACE/themes/blue/pace-theme-minimal.css"/>'>
